...
import { useEditNote } from "@/hooks/use-editNote";
...
export default function EditNote({ note }: { note: INote }) {
    const { form, isLoading, dialogIsOpen, handleOpenChange, submit, fileState, setFileState } = useEditNote(note);
