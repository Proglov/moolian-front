...
import { categoriesObject, extractFileName, flavorsObject, numberToWords, seasonsObject } from "@/lib/utils";
                            ...
                            <form onSubmit={form.handleSubmit(submit)} className="space-y-6 max-w-md mx-auto">
                                ...
                                <div>
                                    ...
                                    <div className="w-2/3 flex flex-col gap-4 mx-auto">
                                        {
                                            product.imageKeys.map((src, i) => {
                                                const filename = extractFileName(src) || ""
                                                const isDeleted = isImageDeleted(filename);
                                                ...
                                                return <div key={src + i} className="text-center">
                                                    <Image
                                                        ...
                                                        src={src}
                                                    />
                                                    <Button type="button" className="mt-1 border-destructive" disabled={isDeleted} variant={isDeleted ? 'secondary' : 'outline'} onClick={() => { onImageRemove(filename) }}>
                                                        حذف تصویر
                                                    </Button>
                                                </div>
                                            })
