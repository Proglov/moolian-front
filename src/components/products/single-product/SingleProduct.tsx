...
export default function SingleProduct({ id }: { id: string }) {
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <Card className="w-full max-w-xl mx-auto p-4 sm:p-4 mt-2 sm:mt-5 border-purple-900">
                <CardContent className="p-3 grid gap-4 sm:grid-cols-2 sm:items-center">
            ...
            {/* add button */}
            <Card className="w-full max-w-xl mx-auto p-4 sm:p-4 mt-2 sm:mt-5 border-success">
...
const CustomTabs = ({ product }: { product: IProduct }) => (
    <Tabs defaultValue="details" className="w-full items-start max-w-xl mx-auto mt-5" dir="rtl">
        <TabsList>
